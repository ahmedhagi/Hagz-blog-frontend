    ...
    return(
        ...
        {  methods.formState.errors &&  methods.formState.errors.editor ? (
          ...
          <div className="tw-mt-2">
          {
            ...
            (
                <>
                <button class="primary-btn tw-px-3 tw-py-1 tw-text-base  tw-mb-3" 
                onClick = { (e) => handleUpdate(e)}>
                Update
                </button>
                <button class="primary-btn tw-px-3 tw-py-1 tw-text-base tw-ml-2 tw-mb-3" 
            ...
            :  
            (
                <button class="primary-btn tw-px-4 tw-py-2 tw-text-base  tw-mb-3" 
